...
//	         create data elements and place them under root
	...
	public static String newGame(){
		...
		String testLevel = "wwwweww%weeeeee%weeeeee%weeeeee%weeeeee%@nnnndnn%nnnsnnn%nnnnnnn%nnnnnnn%nnnncnz%@nnnnnnn%nnnnnnn%nnnlnnn%nnnnnnn%nnbnnnn%@1234@<Level><Split>101%1234%0%0%2%3%3%@<Player><Split>";
		return testLevel;
	}
